...
class Patient {
    ...
    static hasMany = [appointment:Appointment, prescription:Prescription] //hasMany Relationships
    static belongsTo = [doctor:Doctor, surgery:Surgery] //belongsTo Relationships
}